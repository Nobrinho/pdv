 ...
 * Usa a BarcodeDetector API nativa (sem dependências). Onde não houver suporte
 * (ex.: alguns navegadores desktop / iOS antigo), mostra mensagem para digitar
 * o código manualmente. Chama onDetected(code) ao ler.
 */
      ...
      try {
        ...
        const tick = async () => {
          ...
          try {
            ...
            /* frame não pronto — ignora e continua */
          }

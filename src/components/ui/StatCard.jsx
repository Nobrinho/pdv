...
const StatCard = ({
  ...
  const colorMap = {
    blue: { border: "border-blue-500", text: "text-gray-800", icon: "text-blue-200" },
    ...
    gray: { border: "border-gray-500", text: "text-gray-800", icon: "text-gray-200" },
  };
  ...
  return (
    <div
      className={`bg-white p-4 rounded-xl shadow-sm border-l-4 ${colors.border} relative group cursor-help transition-transform hover:scale-[1.02] flex items-center justify-between ${className}`}
    >
      {tooltip && (

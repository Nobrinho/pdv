...
interface AlertContextType {
  showAlert: (message: string, title?: string, type?: "info" | "error" | "success" | "confirm") => Promise<boolean>;
...
export const AlertProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const showAlert = (message: string, title = "Aviso", type: "info" | "error" | "success" | "confirm" = "info"): Promise<boolean> => {
  ...
  const showConfirm = (message: string, title = "Confirmação"): Promise<boolean> => {
    return new Promise((resolve) => {
      setAlertState({
        isOpen: true,
        title,
